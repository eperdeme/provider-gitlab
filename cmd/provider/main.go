...
import (
	...
	"github.com/eperdeme/provider-gitlab/apis"
	"github.com/eperdeme/provider-gitlab/apis/v1alpha1"
	"github.com/eperdeme/provider-gitlab/config"
	"github.com/eperdeme/provider-gitlab/internal/clients"
	"github.com/eperdeme/provider-gitlab/internal/controller"
	"github.com/eperdeme/provider-gitlab/internal/features"
)

func main() {
	var (
		app              = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for GitLab").DefaultEnvars()
