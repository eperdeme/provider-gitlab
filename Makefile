...
PROJECT_REPO ?= github.com/eperdeme/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_REPO ?= https://github.com/gitlabhq/terraform-provider-gitlab
export TERRAFORM_PROVIDER_VERSION ?= 17.1.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-gitlab
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-gitlab_17.1.0
